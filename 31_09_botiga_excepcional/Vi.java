...
public class Vi {
    ...
    /*public static Vi deArrayString(String[] dades) {
        ...
        if (!UtilString.esEnter(dades[2]) || !UtilString.esEnter(dades[3])) {
            return null;
        }
        int preu = Integer.parseInt(dades[2]);
        if (preu < 0) {
    ...
    // Mètode per convertir un objecte Vi a un array de Strings
    ...
    public void setLloc(String lloc) {
        if (lloc == null || lloc.trim().isEmpty()) {
            this.lloc = "P21E45N55E"; // Valor predeterminado para cadenas nulas o vacías
        } else {
            this.lloc = normalitzaString(lloc);
        }
    }
    ...
    // Falta fer que si un valor de preu o estoc ja estaba assignat abans es quedi igual
