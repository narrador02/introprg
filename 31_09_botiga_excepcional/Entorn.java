...
public class Entorn {
    ...
    public void carregarBotiga() throws IOException, BotigaException {
        ...
        if (file.exists()) {
            ...
            while ((linia = br.readLine()) != null) {
                if (cont == botiga.getMaximaCapacitat()) {
    ...
    public String processaModifica(String nom) throws IllegalArgumentException {
    ...
    public void processaElimina(String nom) throws IllegalArgumentException {
        Vi vi = botiga.cerca(nom);
